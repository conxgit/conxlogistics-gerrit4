...
public class VaadinCollapsiblePhysicalAttributeConfirmActualsForm extends VaadinForm {
	...
	private HashMap<PhysicalAttributeConfirmActualsFieldSet, VaadinCollapsiblePhysicalAttributeConfirmActualsFormSectionHeader> headers;
	private HashMap<Field, PhysicalAttributeConfirmActualsFieldSetField> fields;
	private HashMap<PhysicalAttributeConfirmActualsFieldSetField, Integer> fieldIndexMap;

	public VaadinCollapsiblePhysicalAttributeConfirmActualsForm(CollapsiblePhysicalAttributeConfirmActualsForm componentForm) {
		...
		this.headers = new HashMap<PhysicalAttributeConfirmActualsFieldSet, VaadinCollapsiblePhysicalAttributeConfirmActualsFormSectionHeader>();
		this.fields = new HashMap<Field, PhysicalAttributeConfirmActualsFieldSetField>();
		this.innerLayout = new VerticalLayout();
		this.fieldIndexMap = new HashMap<PhysicalAttributeConfirmActualsFieldSetField, Integer>();
	...
	protected void attachField(Object propertyId, Field field) {
		PhysicalAttributeConfirmActualsFieldSet fieldSet = ((CollapsiblePhysicalAttributeConfirmActualsForm) getComponentModel()).getFieldSetForField((String) propertyId);
		if (fieldSet != null) {
			PhysicalAttributeConfirmActualsFieldSetField fieldComponent = fieldSet.getFieldSetField((String) propertyId);
...
//		this.verifyButton.setEnabled(true);
	...
	private VaadinCollapsiblePhysicalAttributeConfirmActualsFormSectionHeader addFormSection(PhysicalAttributeConfirmActualsFieldSet fieldSet) {
	...
	public boolean validateForm() {
		...
		Set<PhysicalAttributeConfirmActualsFieldSet> formFieldHeaders = headers.keySet();
		for (PhysicalAttributeConfirmActualsFieldSet fieldSet : formFieldHeaders) {
...
//			this.saveButton.setEnabled(true);
	...
	private VaadinCollapsiblePhysicalAttributeConfirmActualsFormSectionHeader getFieldHeader(Field field) {
		PhysicalAttributeConfirmActualsFieldSetField fsf = fields.get(field);
		if (fsf != null) {
			PhysicalAttributeConfirmActualsFieldSet fs = fsf.getFieldSet();
			if (fs != null) {
