...
public class VaadinCollapsibleConfirmActualsFormSectionHeader extends HorizontalLayout {
	...
	public VaadinCollapsibleConfirmActualsFormSectionHeader(ConfirmActualsFieldSet fieldSet, Layout layout) {
		this.layout = layout;
