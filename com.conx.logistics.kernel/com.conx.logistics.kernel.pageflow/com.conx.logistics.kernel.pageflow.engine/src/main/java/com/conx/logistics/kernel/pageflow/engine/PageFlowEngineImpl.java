...
@Deprecated
public class PageFlowEngineImpl {
//
...
//	private final Map<String, Map<String,BasePageFlowPage>> pageCache = Collections
//			.synchronizedMap(new HashMap<String, Map<String,BasePageFlowPage>>());
...
//	}
//
//	private Map<String,BasePageFlowPage> getPages(String processId) {
...
//			BasePageFlowPage page, Map<String, Object> properties) {
//		String processId = (String)properties.get(BasePageFlowPage.PROCESS_ID);
//		String taskName = (String)properties.get(BasePageFlowPage.TASK_NAME);
//		logger.debug("registerPageFlowPage("+processId+","+taskName+")");		
//		Map<String,BasePageFlowPage> map = this.pageCache.get(processId);
//		if (map == null) {
//			map = new HashMap<String,BasePageFlowPage>();
...
////			ut.begin();
////
////			Map<String,BasePageFlowPage> pageList = pageCache.get(processId);
...
////			for (BasePageFlowPage page : session.getOrderedPageList()) {
