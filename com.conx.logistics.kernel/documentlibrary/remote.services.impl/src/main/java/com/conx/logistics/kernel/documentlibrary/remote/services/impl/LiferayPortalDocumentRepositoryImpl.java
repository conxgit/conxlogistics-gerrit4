...
public class LiferayPortalDocumentRepositoryImpl implements IRemoteDocumentRepository {
	...
	protected Properties loadLiferayProperties() {
		...
		try {
			liferayProperties.load(LiferayPortalDocumentRepositoryImpl.class.getResourceAsStream("/conxdocrepo.properties"));
		} catch (IOException e) {
			throw new RuntimeException("Could not load conxportal.properties", e);
		}
