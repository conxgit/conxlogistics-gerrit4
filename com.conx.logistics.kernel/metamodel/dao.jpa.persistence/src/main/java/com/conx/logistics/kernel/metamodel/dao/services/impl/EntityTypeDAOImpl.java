...
//		em.persist(record);
	...
	private EntityType provideEntityType(IdentifiableType jpaEntityType) throws Exception {
		...
		if (classCount == 1) {
			...
			com.conx.logistics.mdm.domain.metamodel.AbstractAttribute attribute;
			...
			for (SingularAttribute singularAttribute : singularAttributes) {
				...
				if (persistenceAttributeType == PersistentAttributeType.BASIC) {
					...
					// int,
					// double etc.)
					attribute = new com.conx.logistics.mdm.domain.metamodel.BasicAttribute(singularAttribute.isId(), singularAttribute.getName(), singularAttribute.getJavaType(), entityType);
					...
					attribute = new com.conx.logistics.mdm.domain.metamodel.SingularAttribute(singularAttribute.getName(), singularAttribute.getJavaType(), singularAttribute.isId(),
			...
			com.conx.logistics.mdm.domain.metamodel.PluralAttribute collectionAttribute = null;
			...
			for (PluralAttribute pattr : pluralAttributes) {
				...
				if (persistenceAttributeType == PersistentAttributeType.ONE_TO_MANY || persistenceAttributeType == PersistentAttributeType.MANY_TO_MANY) {
					...
					if (pattr.getCollectionType() == CollectionType.LIST) {
						...
						collectionAttribute = (com.conx.logistics.mdm.domain.metamodel.PluralAttribute) add(collectionAttribute);
	...
	// // double etc.)
	// attribute = new
	// com.conx.logistics.mdm.domain.metamodel.BasicAttribute(sattr.isId(),
	...
	// attribute = new
	// com.conx.logistics.mdm.domain.metamodel.SingularAttribute(sattr.getName(),
	...
	// (com.conx.logistics.mdm.domain.metamodel.SingularAttribute) attribute));
	// }
	//
	// }
	//
	...
	// pattr_ = (com.conx.logistics.mdm.domain.metamodel.PluralAttribute)
	// add(pattr_);
