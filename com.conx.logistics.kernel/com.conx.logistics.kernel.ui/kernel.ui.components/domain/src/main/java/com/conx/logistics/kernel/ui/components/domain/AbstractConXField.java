...
@Entity
public abstract class AbstractConXField extends AbstractConXComponent implements Sizeable {
    ...
    public AbstractConXField() {
    	super("field");
    }
    
    public AbstractConXField(String typeId) {
    	super(typeId);
    }    

	public AbstractConXField(DataSourceField dataSourceField,
