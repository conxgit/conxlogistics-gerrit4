...
public abstract class FilterTableExport {

    private static final long serialVersionUID = -2972527330991334117L;
    private static final Logger LOGGER = Logger.getLogger(FilterTableExport.class.getName());
    ...
    public FilterTableExport(final FilterTable table) {
        this.setTable(table);
    }
    ...
    public void setTable(final FilterTable table) {
        this.table = table;
