package com.conx.logistics.kernel.ui.vaadin.common.gwt.client;
...
public class VGoogleAnalytics extends Widget implements Paintable {
    ...
    public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
        ...
        if (null != res) {
            VConsole.log("WebAnalytics.trackPageview(" + trackerId + ","
                    + pageId + "," + domainName + ") FAILED: " + res);
        } else {
            VConsole.log("WebAnalytics.trackPageview(" + trackerId + ","
                    + pageId + "," + domainName + ") SUCCESS.");
        }
    }
