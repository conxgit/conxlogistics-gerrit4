...
public class ConXEntityEditorFormSeparator extends HorizontalLayout {
	private static final long serialVersionUID = 1010002929298L;
	
	private Embedded arrow;
	private String title;
	private ConXEntityEditorFormSection section;
	private Label label;
	private boolean expanded;

	public ConXEntityEditorFormSeparator(String title, ConXEntityEditorFormSection section) {
		this.title = title;
