...
public class VConXSplitPanel extends ComplexPanel implements Container, ContainerResizedListener {
    ...
    public VConXSplitPanel() {
        this(ORIENTATION_HORIZONTAL);
    }

    public VConXSplitPanel(int orientation) {
    ...
    public void onMouseUp(Event event) {
        ...
        updateFirstContainerHeightToServer();
        updateSecondContainerHeightToServer();
    }
    ...
    private void showDraggingCurtain() {
        ...
        if (draggingCurtain == null) {
            ...
            DOM.setStyleAttribute(draggingCurtain, "zIndex", "20000");
...
//        int firstContainerHeight = 0;
//        if (firstContainer != null) {
//        	firstContainerHeight = firstContainer.getClientHeight();
//        }
//        int secondContainerHeight = 0;
//        if (secondContainer != null) {
//        	secondContainerHeight = secondContainer.getClientHeight();
//        }
        client.updateVariable(id, "position", pos, immediate);
    }
    
    private void updateFirstContainerHeightToServer() {
        if (firstContainer != null) {
        	int firstContainerHeight = firstContainer.getClientHeight();
        	client.updateVariable(id, "firstContainerHeight", firstContainerHeight, immediate);
        }
    }
    
    private void updateSecondContainerHeightToServer() {
        if (secondContainer != null) {
        	int secondContainerHeight = secondContainer.getClientHeight();
        	client.updateVariable(id, "secondContainerHeight", secondContainerHeight, immediate);
        }
    }
