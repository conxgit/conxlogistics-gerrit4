 ...
 */
@Deprecated
public class VConXQuickLaunchMenuItem extends UIObject implements HasHTML {

    private static final String DEPENDENT_STYLENAME_SELECTED_ITEM = "selected";

    private Command command;
    private VConXQuickLaunchMenu parentMenu, subMenu;
     ...
     */
    public VConXQuickLaunchMenuItem(String text, Command cmd) {
        this(text, false);
        setCommand(cmd);
    }
     ...
     *            the command to be fired when it is selected
     */
    public VConXQuickLaunchMenuItem(String text, boolean asHTML, Command cmd) {
        this(text, asHTML);
        setCommand(cmd);
    }
     ...
     */
    public VConXQuickLaunchMenuItem(String text, VConXQuickLaunchMenu subMenu) {
        this(text, false);
        setSubMenu(subMenu);
    }
     ...
     *            the sub-menu to be displayed when it is selected
     */
    public VConXQuickLaunchMenuItem(String text, boolean asHTML, VConXQuickLaunchMenu subMenu) {
        this(text, asHTML);
        setSubMenu(subMenu);
    }
     ...
     */
    public VConXQuickLaunchMenu getParentMenu() {
        return parentMenu;
    }
     ...
     */
    public VConXQuickLaunchMenu getSubMenu() {
        return subMenu;
    }
     ...
     */
    public void setSubMenu(VConXQuickLaunchMenu subMenu) {
    ...
    void setParentMenu(VConXQuickLaunchMenu parentMenu) {
