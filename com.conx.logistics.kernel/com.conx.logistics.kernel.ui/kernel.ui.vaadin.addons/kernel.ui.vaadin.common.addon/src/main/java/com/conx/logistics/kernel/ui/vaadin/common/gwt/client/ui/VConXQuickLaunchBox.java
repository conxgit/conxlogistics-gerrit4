...
public class VConXQuickLaunchBox extends Composite implements Paintable, Field,
     ...
     * menu.
     */
    public class SuggestionPopup extends VConxMenuOverlay implements PositionCallback,
        ...
        public void showSuggestions(
            ...
            final int x = VConXQuickLaunchBox.this.getAbsoluteLeft();
        ...
        public void selectNextItem() {
            final VConXQuickLaunchMenuItem cur = menu.getSelectedItem();
            final int index = 1 + menu.getItems().indexOf(cur);
            if (menu.getItems().size() > index) {
                final VConXQuickLaunchMenuItem newSelectedItem = menu.getItems().get(index);
        ...
        public void selectPrevItem() {
            ...
            if (index > -1) {
                ...
                final VConXQuickLaunchMenuItem newSelectedItem = menu.getItems().get(
        ...
        public void setPosition(int offsetWidth, int offsetHeight) {
            ...
            if (offsetHeight + getPopupTop() > Window.getClientHeight()
                ...
                top = getPopupTop() - offsetHeight
                        - VConXQuickLaunchBox.this.getOffsetHeight();
                if (top < 0) {
                    top = 0;
                }
            } else {
            ...
            if (offsetWidth + getPopupLeft() > Window.getClientWidth()
                ...
                left = VConXQuickLaunchBox.this.getAbsoluteLeft()
                        + VConXQuickLaunchBox.this.getOffsetWidth()
     ...
     */
    public class SuggestionMenu extends VConXQuickLaunchMenu implements SubPartAware,
            LoadHandler {
         ...
         */
        private VConXQuickLaunchMenuItem keyboardSelectedItem;
        ...
        public void setSuggestions(
            ...
            while (it.hasNext()) {
                ...
                final VConXQuickLaunchMenuItem mi = new VConXQuickLaunchMenuItem(s.getDisplayString(), true, s);
        ...
        public void doPostFilterSelectedItemAction() {
            final VConXQuickLaunchMenuItem item = getSelectedItem();
            final String enteredItemValue = tb.getText();
            ...
            if (p > 0) {
                for (int i = 0; i < p; i++) {
                    final VConXQuickLaunchMenuItem potentialExactMatch = getItems().get(i);
        ...
        public Element getSubPartElement(String subPart) {
            ...
            VConXQuickLaunchMenuItem item = getItems().get(index);
        ...
        public void selectFirstItem() {
            VConXQuickLaunchMenuItem firstItem = getItems().get(0);
            selectItem(firstItem);
        }

        private VConXQuickLaunchMenuItem getKeyboardSelectedItem() {
            return keyboardSelectedItem;
        }

        private void setKeyboardSelectedItem(VConXQuickLaunchMenuItem firstItem) {
            keyboardSelectedItem = firstItem;
        }

        public void selectLastItem() {
            List<VConXQuickLaunchMenuItem> items = getItems();
            VConXQuickLaunchMenuItem lastItem = items.get(items.size() - 1);
            selectItem(lastItem);
        }
    }
    ...
    private final TextBox tb = new TextBox() {
        ...
        public void onBrowserEvent(Event event) {
            ...
            if (client != null) {
                client.handleTooltipEvent(event, VConXQuickLaunchBox.this);
            }
        }
    ...
    public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
        ...
        if (waitingForFilteringResponse
            ...
            if (!popupOpenerClicked
                ...
                // variable as well.
                VConXQuickLaunchMenuItem activeMenuItem = suggestionPopup.menu
                        .getSelectedItem();
