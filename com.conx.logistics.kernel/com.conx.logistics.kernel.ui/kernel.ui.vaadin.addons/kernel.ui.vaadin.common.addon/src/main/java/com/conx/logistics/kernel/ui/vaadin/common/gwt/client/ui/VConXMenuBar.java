...
public class VConXMenuBar extends SimpleFocusablePanel implements Paintable,
    ...
    protected VConxMenuOverlay popup;
    protected VConXMenuBar visibleChildMenu;
    protected boolean menuVisible = false;
    protected VConXMenuBar parentMenu;
    ...
    public VConXMenuBar(boolean subMenu, VConXMenuBar parentMenu) {
    ...
    public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
        ...
        if (uidl.hasAttribute("width")) {
            ...
            collapsedRootItems = new VConXMenuBar(true,
                    (VConXMenuBar) client.getPaintable(uidlId));
        ...
        Stack<VConXMenuBar> menuStack = new Stack<VConXMenuBar>();
        VConXMenuBar currentMenu = this;
        ...
        while (itr.hasNext()) {
            ...
            if (item.getChildCount() > 0) {
                ...
                currentMenu = new VConXMenuBar(true, currentMenu);
    ...
    public void onBrowserEvent(Event e) {
        ...
        if (DOM.eventGetType(e) == Event.ONLOAD) {
            ...
            VConXMenuBar parent = getParentMenu();
            if (parent != null) {
        ...
        if (targetItem != null) {
            ...
            case Event.ONCLICK:
                ...
                if (subMenu) {
                    ...
                    VConXMenuBar parent = parentMenu;
    ...
    private static class LazyCloser extends Timer {
        ...
        private VConXMenuBar activeRoot;
        ...
        public static void prepare(VConXMenuBar vMenuBar) {
            if (INSTANCE == null) {
    ...
    protected void showChildMenuAt(CustomMenuItem item, int top, int left) {
        ...
        popup = new VConxMenuOverlay(true, false, true);
     ...
     * @return
     */
    public VConXMenuBar getParentMenu() {
        return parentMenu;
    }
     ...
     * @param parent
     */
    public void setParentMenu(VConXMenuBar parent) {
        parentMenu = parent;
    }
    ...
    protected static class CustomMenuItem extends Widget implements HasHTML {
        ...
        protected VConXMenuBar subMenu = null;
        protected VConXMenuBar parentMenu = null;
        ...
        public void setSubMenu(VConXMenuBar subMenu) {
            this.subMenu = subMenu;
        }

        public VConXMenuBar getSubMenu() {
            return subMenu;
        }

        public void setParentMenu(VConXMenuBar parentMenu) {
            this.parentMenu = parentMenu;
        }
        ...
        public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
            ...
            if (uidl.hasAttribute("description")) {
                ...
                VConXMenuBar root = findRootMenu();
        ...
        private VConXMenuBar findRootMenu() {
            VConXMenuBar menubar = getParentMenu();
    ...
    public boolean handleNavigation(int keycode, boolean ctrl, boolean shift) {
        ...
        if (keycode == getNavigationLeftKey()) {
            if (getSelected() == null) {
                ...
                VConXMenuBar root = getParentMenu();
    ...
    private void openMenuAndFocusFirstIfPossible(CustomMenuItem menuItem) {
        VConXMenuBar subMenu = menuItem.getSubMenu();
        if (subMenu == null) {
            // No child menu? Nothing to do
            return;
        }

        VConXMenuBar parentMenu = menuItem.getParentMenu();
