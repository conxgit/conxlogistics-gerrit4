...
@com.vaadin.ui.ClientWidget(com.conx.logistics.kernel.ui.vaadin.common.gwt.client.ui.VConXQuickLaunchBox.class)
public class ConXQuickLaunchBox extends Select {
    ...
    public ConXQuickLaunchBox() {
        setMultiSelect(false);
        setNewItemsAllowed(false);
    }

    public ConXQuickLaunchBox(String caption, Collection<?> options) {
        super(caption, options);
        setMultiSelect(false);
        setNewItemsAllowed(false);
    }

    public ConXQuickLaunchBox(String caption, Container dataSource) {
        super(caption, dataSource);
        setMultiSelect(false);
        setNewItemsAllowed(false);
    }

    public ConXQuickLaunchBox(String caption) {
        super(caption);
        setMultiSelect(false);
        setNewItemsAllowed(false);
    }
