...
import com.conx.logistics.kernel.ui.vaadin.common.gwt.client.VActiveLink;
import com.conx.logistics.kernel.ui.vaadin.common.gwt.client.ui.VConXMenuBar;
...
@ClientWidget(value = VConXMenuBar.class, loadStyle = LoadStyle.LAZY)
public class ConXMenuBar extends AbstractComponent {
     ...
     */
    public ConXMenuBar.MenuItem addItem(String caption, ConXMenuBar.Command command) {
     ...
     * @throws IllegalArgumentException
     */
    public ConXMenuBar.MenuItem addItem(String caption, Resource icon,
            ConXMenuBar.Command command) {
        if (caption == null) {
     ...
     * @throws IllegalArgumentException
     */
    public ConXMenuBar.MenuItem addItemBefore(String caption, Resource icon,
            ConXMenuBar.Command command, ConXMenuBar.MenuItem itemToAddBefore) {
        if (caption == null) {
            throw new IllegalArgumentException("caption cannot be null");
        }
     ...
     */
    public void removeItem(ConXMenuBar.MenuItem item) {
        if (item != null) {
    ...
    public interface Command extends Serializable {
        public void menuSelected(ConXMenuBar.MenuItem selectedItem);
    }
    ...
    public class MenuItem implements Serializable {
         ...
         * @throws IllegalArgumentException
         */
        public MenuItem(String caption, Resource icon, ConXMenuBar.Command command) {
            if (caption == null) {
                throw new IllegalArgumentException("caption cannot be null");
            }
            itsId = ++numberOfItems;
         ...
         * @since 6.2.0
         */
        public ConXMenuBar.MenuItem addSeparator() {
            MenuItem item = addItem("", null, null);
            item.setSeparator(true);
            return item;
        }

        public ConXMenuBar.MenuItem addSeparatorBefore(MenuItem itemToAddBefore) {
         ...
         */
        public ConXMenuBar.MenuItem addItem(String caption, Resource icon,
                ConXMenuBar.Command command) throws IllegalStateException {
            if (isSeparator()) {
         ...
         */
        public ConXMenuBar.MenuItem getParent() {
            return itsParent;
        }
         ...
         */
        public void setCommand(ConXMenuBar.Command command) {
            itsCommand = command;
        }
         ...
         *            The item to be removed
         */
        public void removeChild(ConXMenuBar.MenuItem item) {
         ...
         *            The parent item
         */
        protected void setParent(ConXMenuBar.MenuItem parent) {
            itsParent = parent;
        }
