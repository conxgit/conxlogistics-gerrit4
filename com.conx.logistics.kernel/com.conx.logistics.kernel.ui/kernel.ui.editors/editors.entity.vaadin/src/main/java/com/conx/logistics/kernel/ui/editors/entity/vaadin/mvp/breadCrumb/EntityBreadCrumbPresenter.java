package com.conx.logistics.kernel.ui.editors.entity.vaadin.mvp.breadCrumb;
...
import com.conx.logistics.kernel.ui.editors.entity.vaadin.mvp.breadCrumb.view.EntityBreadCrumbView;
import com.conx.logistics.kernel.ui.editors.entity.vaadin.mvp.breadCrumb.view.IEntityBreadCrumbView;
...
public class EntityBreadCrumbPresenter extends ConfigurableBasePresenter<IEntityBreadCrumbView, EntityBreadCrumbEventBus> {
	...
	private void recurseBreadCrumb(final MultiLevelEntityEditorPresenter presenter) {
		...
		if (!presenter.equals(multiLevelEntityEditorPresenter)) {
			...
			if (itemCode != null) {
				item.setCaption(presenter.getMetaData().getName() + " (" + itemCode + ")");
			}
		}
