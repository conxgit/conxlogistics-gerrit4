...
import org.vaadin.teemu.wizards.event.custom.CustomWizardCancelledEvent;
import org.vaadin.teemu.wizards.event.custom.CustomWizardCompletedEvent;
import org.vaadin.teemu.wizards.event.custom.CustomWizardProgressListener;
import org.vaadin.teemu.wizards.event.custom.CustomWizardStepActivationEvent;
import org.vaadin.teemu.wizards.event.custom.CustomWizardStepSetChangedEvent;
...
public class CustomWizard extends CustomComponent implements FragmentChangedListener {
    ...
    private void initDefaultHeader() {
    	CustomWizardProgressBar progressBar = new CustomWizardProgressBar(this);
    ...
    public void addStep(WizardStep step, String id) {
        ...
        // notify listeners
        fireEvent(new CustomWizardStepSetChangedEvent(this));
    }
    ...
    public void addListener(CustomWizardProgressListener listener) {
        addListener(CustomWizardCompletedEvent.class, listener,
    ...
    public void removeListener(CustomWizardProgressListener listener) {
        removeListener(CustomWizardCompletedEvent.class, listener,
                WIZARD_COMPLETED_METHOD);
        removeListener(CustomWizardCompletedEvent.class, listener,
                WIZARD_ACTIVE_STEP_CHANGED_METHOD);
        removeListener(CustomWizardCompletedEvent.class, listener,
...
//        contentPanel.setContent((ComponentContainer) step.getContent());
        ...
        updateUriFragment();
        updateButtons();
        fireEvent(new CustomWizardStepActivationEvent(this, step));
    }
     ...
     */
    public void cancel() {
        fireEvent(new CustomWizardCancelledEvent(this));
    }
    ...
    public void finish() {
        if (isLastStep(currentStep) && currentStep.onAdvance()) {
            ...
            fireEvent(new CustomWizardCompletedEvent(this));
        }
    }
