...
public class ContactTypeDAOImpl implements IContactTypeDAOService {
	...
	public List<ContactType> getAll() {
		return em.createQuery("select o from com.conx.logistics.mdm.domain.organization.ContactType o record by o.id", ContactType.class).getResultList();
	}
	...
	public ContactType getByCode(String code) {
		...
		try {
			TypedQuery<ContactType> q = em.createQuery("select o from com.conx.logistics.mdm.domain.organization.ContactType o WHERE o.code = :code", ContactType.class);
