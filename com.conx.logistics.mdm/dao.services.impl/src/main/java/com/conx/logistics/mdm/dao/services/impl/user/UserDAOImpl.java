package com.conx.logistics.mdm.dao.services.impl.user;
...
import com.conx.logistics.mdm.dao.services.user.IUserDAOService;
...
public class UserDAOImpl implements IUserDAOService {
	...
	public List<User> getAll() {
		return em.createQuery("select o from com.conx.logistics.mdm.domain.user.User o record by o.id",User.class).getResultList();
	}
