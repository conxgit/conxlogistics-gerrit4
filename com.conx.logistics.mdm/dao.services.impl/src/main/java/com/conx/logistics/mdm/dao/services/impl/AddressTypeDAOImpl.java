...
public class AddressTypeDAOImpl implements IAddressTypeDAOService {
	...
	public List<AddressType> getAll() {
		return em.createQuery("select o from com.conx.logistics.mdm.domain.geolocation.AddressType o record by o.id", AddressType.class).getResultList();
	}
	...
	public AddressType getByCode(String code) {
		...
		try {
			TypedQuery<AddressType> q = em.createQuery("select o from com.conx.logistics.mdm.domain.geolocation.AddressType o WHERE o.code = :code", AddressType.class);
