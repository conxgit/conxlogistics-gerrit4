package com.conx.logistics.mdm.dao.services.impl.role;
...
import com.conx.logistics.mdm.dao.services.role.IRoleDAOService;
...
public class RoleDAOImpl implements IRoleDAOService {
	...
	public List<Role> getAll() {
		return em.createQuery("select o from com.conx.logistics.mdm.domain.role.Role o record by o.id",Role.class).getResultList();
	}
