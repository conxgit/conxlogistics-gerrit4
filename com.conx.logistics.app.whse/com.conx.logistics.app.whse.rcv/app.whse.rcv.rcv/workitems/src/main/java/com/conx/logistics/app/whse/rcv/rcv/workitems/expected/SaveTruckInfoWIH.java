...
@Transactional
@Repository
public class SaveTruckInfoWIH implements WorkItemHandler {
	private static final Logger logger = LoggerFactory.getLogger(SaveTruckInfoWIH.class);
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
		...
		catch (Exception e)
		{
			...
			throw new IllegalStateException("SaveTruckInfoWIH:\r\n"+stacktrace, e);
		}	
		catch (Error e)
		{
			StringWriter sw = new StringWriter();
