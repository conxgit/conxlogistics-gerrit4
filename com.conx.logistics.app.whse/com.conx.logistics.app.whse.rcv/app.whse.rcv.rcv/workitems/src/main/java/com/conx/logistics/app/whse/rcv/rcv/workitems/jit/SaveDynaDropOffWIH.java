...
@Transactional
@Repository
public class SaveDynaDropOffWIH implements WorkItemHandler {
	private static final Logger logger = LoggerFactory.getLogger(SaveDynaDropOffWIH.class);
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
		...
		catch (Exception e)
		{
			...
			throw new IllegalStateException("SaveDropOffWIH:\r\n"+stacktrace, e);
		}	
		catch (Error e)
		{
			StringWriter sw = new StringWriter();
