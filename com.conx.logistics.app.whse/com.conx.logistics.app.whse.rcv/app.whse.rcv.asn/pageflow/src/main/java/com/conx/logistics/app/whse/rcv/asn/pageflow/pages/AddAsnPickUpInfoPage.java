...
public class AddAsnPickUpInfoPage extends BasePageFlowPage implements
	...
	private LineEditorContainerComponent buildLineEditors() {
		LineEditorContainerComponent asnLineLineEditorContainer = new LineEditorContainerComponent(
				"addasnpickup-asnlinelineeditorcontainer",
				"addasnpickup-asnlinelineeditorcontainer");

		LineEditorComponent attachmentsFormLineEditor = new LineEditorComponent(
				"addasnpickup-attachmentsasnlinelineeditor", "Attachments",
	...
	private ConXForm buildEditorForm() {
		...
		// Org Field
		DataSourceField orgDsField = new DataSourceField("pickup",
				asnDataSource, null, "Pick Up Organization");
		...
		// Contact Field
		DataSourceField contactDsField = new DataSourceField("pickup",
		...
		// Address Field
		DataSourceField addressDsField = new DataSourceField("pickup",
		...
		// Address Field
		DataSourceField pickupAddressDsField = new DataSourceField("pickup",
				asnDataSource, null, "Pick Up From Address");
		pickupAddressDsField.setValueXPath("pickUpFromAddress");
		...
		DataSourceField dateTimeDsField = new DataSourceField("pickup",
				asnDataSource, null, "Pick Up Date & Time");
		dateTimeDsField.setValueXPath("estimatedPickup");
	...
	private MasterDetailComponent buildEditor() {
		...
		MasterDetailComponent asnLineMasterDetail = new MasterDetailComponent(
				"addasnpickup-asnmasterdetail", "ASN");
