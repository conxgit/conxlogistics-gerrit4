package com.conx.logistics.app.whse.ui.contribution.stockitem;
...
public class StockItemSearchViewContributionImpl implements IViewContribution {
	
	protected final static String VIEWCODE = "WHSE.IM.SI.SEARCH_SI";
