package com.conx.logistics.reporting.jasperreports.web.service.servlet;
...
@Service
@Transactional
//E.g. http://localhost:9080/reporting/pdfgen?PARAM_REPORT_NAME=stockItemSingleLabelByPK&jrpStockItemCode=RDFLT000001-01L1_0
public class PdfReportingServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		try 
		{
			...
			String reportFileName = context.getRealPath("/jasperreports/"+reportName+".jasper");
			...
			try {
				...
				jasperPrint = JasperFillManager.fillReport(reportFileName,jaspRptingParams, connection);
